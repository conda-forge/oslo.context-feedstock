...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/oslo.context-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9812&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/oslo.context-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `oslo.context` can be installed with:

```
conda install oslo.context
```

It is possible to list all of the versions of `oslo.context` available on your platform with:
